...
//         />
//         <h1 className="mt-1 text-center font-semibold text-gray-800">{user.fullName}</h1>
//         <div className='px-6 text-sm text-gray-600 font-medium'>

//         </div>
//       </div>

//       {/* Nav Items */}
//       <div className="flex-1 w-48 space-y-1">
...
//             className={({ isActive }) =>
//               `px-2 py-1.5 flex items-center gap-3 rounded transition-colors duration-200 ${
//                 isActive
